...
final class Version20260407212236 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cities (id UUID NOT NULL, insee_code VARCHAR(10) NOT NULL, name VARCHAR(255) NOT NULL, department_code VARCHAR(10) NOT NULL, region_code VARCHAR(10) NOT NULL, postal_code VARCHAR(10) NOT NULL DEFAULT \'\', created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
